...
<body className='snippet-body' id="body-pd">
    ...
    <div class="container">
        <div class="btnaj">
            <a href="Creer_projet.jsp" class="btn btn-warning text-white">Créer Project</a>
        </div>
        <div class="contenu">
            <%
            ...
            <div class="card-deck">
                <div class="card text-center shadow mb-3" style="max-width: 20rem;">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="deleteProjet?id_Proj=<%= projet.getId_Proj() %>" class="btn btn-warning text-white">Supprimer</a>
                        <a href="AfficherTache?id_Proj=<%= projet.getId_Proj() %>" class="btn btn-warning text-white">Tache</a>
